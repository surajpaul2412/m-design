                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="login-wrapper">
                                            ...
                                            <div class="login-inner">
                                                <!-- Login Logo -->
                                                <a href="index.html" class="logo d-inline-block mb-4"><img src="assets/images/logo.png" alt="logo" /></a>
                                                <!-- End Login Logo -->
                                                <!-- User Form -->
                                                <div class="user-loginforms">
                                                    <form class="text-left" action="#" method="post">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <button type="submit" class="btn btn-primary rounded w-100 forgoted-link">Reset password</button>
                                                                </div> 
                                                                <div class="col-lg-12 text-center mt-2">
                                                                    Go back to<a href="login.php" class="fw-500 ms-1 btn-link back-to-login">Sign In</a>
                                                                </div>
                                                            </div>  
                                                        </div>
                                                    </form>
