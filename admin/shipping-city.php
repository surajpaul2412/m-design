...
<head> 
        <meta charset="utf-8" />
        <title>Shipping City | MbizSpare</title>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select2">
                                                                    ...
                                                                    <option value="AK">Uttar Pradesh</option>
                                                                    <option value="HI">Haryana</option> 
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="name" class="form-control" placeholder="Enter Shipping Cost..." required/>
                                                            </div>
                                                        </div>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Uttar Pradesh</td>
                                                    <td>
                                                        <b><i class="bx bx-rupee"></i>50.00</b>
                                                    </td>
                                                    ...
                                                    <td class="text-center">  
                                                        <a href="#" class="btn btn-soft-info btn-sm waves-effect waves-light"><i class="bx bx-pencil font-size-16"></i></a> 
