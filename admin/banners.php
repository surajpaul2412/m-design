...
<head> 
        <meta charset="utf-8" />
        <title>All Banners | MbizSpare</title>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        ...
                                        <a href="add-banner.php" class="btn btn-primary waves-effect waves-light"><i class="fas fa-plus"></i> Add New Banner</a>
                                    </div>
                                    ...
                                    <div class="card-body"> 
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                <tr> 
                                                    <td>1</td>
                                                    <td class="text-wrap">Slide 01</td> 
                                                    <td>
                                                    ...
                                                    <td class="text-center">  
                                                        <a href="add-banner.php" class="btn btn-soft-info btn-sm waves-effect waves-light"><i class="bx bx-pencil font-size-16"></i></a> 
