...
<head> 
        <meta charset="utf-8" />
        <title>View Seller Profile | MbizSpare</title>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right"> 
                                        <a href="sellers.php" class="btn btn-primary waves-effect waves-light"><i class="fas fa-reply-all"></i> Back to list</a>
                                    </div>
                                    ...
                                    <div class="bg-success bg-soft">
                                        <div class="row">
                                            <div class="col-12 text-end">
                                                <div class="p-3"><span class="badge badge-pill badge-soft-success font-size-12 p-2 border w-md">Account is Verified </span></div>
                                            </div> 
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="avatar-md profile-user-wid">
                                                    <img src="../assets/admin/images/users/avatar-3.jpg" alt="" class="img-thumbnail rounded-circle">
                                                </div> 
                                            </div>

                                            <div class="col">
                                                <div class="">  
                                                    <h5 class="font-size-15 text-truncate m-0">Abhishek Singh</h5>
                                                    <p class="text-muted mb-0 text-truncate">[Aisha Decore]</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <table class="table table-striped m-0"> 
                                                    <tbody>
                                                        <tr>
                                                            <td>Email Id</td>
                                                            <td><a href="#">seller@gmail.com</a></td>
                                                        </tr> 
                                                        <tr>
                                                            <td>Contact Number</td>
                                                            <td><a href="#">+91 9999585812</a></td>
                                                        </tr> 
                                                        <tr>
                                                            <td>DOB</td>
                                                            <td>01-07-1992</td>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium">Earned Amount</p>
                                                        <h4 class="mb-0"><i class="bx bx-rupee"></i>1235.00</h4>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <h4 class="mb-0"><i class="bx bx-rupee"></i>500.00</h4>
                                                    </div>
                                        ...
                                        <div class="row"> 
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="Robin Roy" disabled/> 
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="SBI" disabled/> 
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="name" class="form-label">IFSC Code:</label>
                                                    <input type="text" class="form-control" value="SBIN001085" disabled/> 
                                                </div>
                                            </div> 
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="name" class="form-label">Branch Name:</label>
                                                    <input type="text" class="form-control" value="Noida" disabled/>
                                                </div>
                                            </div>
                                        </div> 
                                    </div> 
                                        ...
                                        <div class="row"> 
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="robin@okaxis" disabled/>
                                                </div>
                                            </div>  
                                        </div> 
                                    </div>  
