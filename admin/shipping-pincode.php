...
<head> 
        <meta charset="utf-8" />
        <title>Shipping Pincode | MbizSpare</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Shipping Pincode</h4>
                                            ...
                                            <div class="row"> 
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label for="name" class="form-label">Choose City <sup class="text-danger fs-5">*</sup> :</label>
                                                                <select class="form-control select2">
                                                                    <option>Select</option> 
                                                                    <option value="AK">Noida</option>
                                                                    <option value="HI">Agra</option> 
                                                                </select>
                                                            </div>
                                                        </div>
