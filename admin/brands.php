...
<head> 
        <meta charset="utf-8" />
        <title>All Brands | MbizSpare</title>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        ...
                                        <a href="add-brand.php" class="btn btn-primary waves-effect waves-light"><i class="fas fa-plus"></i> Add New Brand</a>
                                    </div>
                                            ...
                                            <tbody>
                                                <tr> 
                                                    ...
                                                    <td class="text-center">  
                                                        <a href="add-brand.php" class="btn btn-soft-info btn-sm waves-effect waves-light"><i class="bx bx-pencil font-size-16"></i></a> 
