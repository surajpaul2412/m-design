...
<head> 
        <meta charset="utf-8" />
        <title>Add Brand | MbizSpare</title>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right"> 
                                        <a href="brands.php" class="btn btn-primary waves-effect waves-light"><i class="fas fa-reply-all"></i> Back to list</a>
                                    </div>
                                ...
                                <form action="#">
                                    ...
                                    <div class="row"> 
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label for="name" class="form-label fw-bold">Brand Name <sup class="text-danger fs-5">*</sup> :</label>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <div class="input-group-text">https://mbizspare.com/brand/</div>
                                        ...
                                        <div class="col-lg-4"> 
                                            ...
                                            <div class="card">
                                                <div class="card-header"> 
                                                    <h4 class="card-title mb-0">Brand Images</h4> 
                                                </div>
                                                <div class="card-body">  
                                                    <div class="row"> 
                                                        <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-label">
                                                                <label class="form-label fw-bold">Brand Icon:</label>
                                                                <input type="file" id="input-file-now" class="dropify" />
