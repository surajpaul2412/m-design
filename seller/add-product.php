...
<script type="text/javascript">
    ...
    $('#choice_attributes').on('change', function() {
        ...
        $.each($("#choice_attributes option:selected"), function(){ 
            $('#customer_choice_options').append('<div class="col-lg-12"><div class="form-group"><div class="input-group"><div class="input-group-text">Size</div><select class="select2 form-control select2-multiple" multiple="multiple" data-placeholder="Choose Values..."><option value="1">Size</option><option value="2">Fabric</option><option value="4">Sleeve</option><option value="5">Wheel</option><option value="6">Liter</option></select></div></div></div>'); 
        }); 
    });  
